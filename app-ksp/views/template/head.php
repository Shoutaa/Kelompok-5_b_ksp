...
<head>
	...
	<!-- Theme -->
	<link rel="stylesheet" href="<?php echo base_url()?>assets/theme/css/style.min.css?1361377732" />
	...
	<!--[if IE]><script type="text/javascript" src="<?php echo base_url()?>assets/theme/scripts/excanvas/excanvas.js"></script><![endif]-->
	<!--[if lt IE 8]><script type="text/javascript" src="<?php echo base_url()?>assets/theme/scripts/json2.js"></script><![endif]-->
